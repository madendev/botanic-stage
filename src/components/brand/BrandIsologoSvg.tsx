...
type BrandIsologoSvgProps = {
  /* {Clases Tailwind adicionales para ajuste responsive} */
  className?: string;
};
...
export default function BrandIsologoSvg({ className = '' }: BrandIsologoSvgProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 173.57 135" className={className}>
      <path
